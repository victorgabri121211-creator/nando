<?php
// Captura o link de afiliado da URL (ex: /registrar?ref=Nando)
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <div class="brand-header">
                ...
                <h1>Nuvem Cloud</h1>
                <p>Crie seus disparos connosco</p>
            </div>
            ...
            <div class="auth-links">
                Já tem uma conta? <br>
                <a href="/login" style="display: inline-block; margin-top: 5px;">Entrar</a>
            </div>
